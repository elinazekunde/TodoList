...
//  TodoList
//
//  Created by Elīna Zekunde on 04/02/2021.
//
...
class TodoTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private func addNewItem() {
        let alertController = UIAlertController(title: "New Task!", message: "What do you wish to add?", preferredStyle: .alert)
        alertController.addTextField { (textField: UITextField) in
            textField.placeholder = "Enter the task description"
